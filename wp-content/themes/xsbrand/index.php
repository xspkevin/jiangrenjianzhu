    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 hidden-xs hidden-sm">
                <?php
                    $cate3 = get_field('news3','option');
                ?>
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active">
                        <a href="#home" aria-controls="idx-about" role="tab" data-toggle="tab"><?php echo $cate3->name; ?></a>
                    </li>
                </ul>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                                    <div class="swiper-slide">
                                        ...
                                        <p>
                                            <a class="banner-title" href="<?php the_permalink(); ?>"  title="详细阅读 <?php the_title(); ?>"><?php the_title(); ?></a>
                                        </p>
                                    </div>
                                <?php endwhile; ?>
            ...
            <div class="col-md-4 col-xs-12 col-sm-6">
                <?php
                    $cate1 = get_field('news1','option');
                    $cate2 = get_field('news2','option');
                ?>
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active">
                        <a href="#idxnews" aria-controls="idxNews" role="tab" data-toggle="tab" aria-expanded="true">
                            <?php echo $cate1->name; ?>
                        </a>
                    </li>
                    <li role="presentation" class="">
                        <a href="#idxnotice" aria-controls="idxNotice" role="tab" data-toggle="tab" aria-expanded="false">
                            <?php echo $cate2->name; ?>
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="idxnews">
                        <ul>
                            ...
                            ?>
                            <li>
                                <a target="_blank" href="<?php the_permalink(); ?>" rel="bookmark" title="详细阅读 <?php the_title(); ?>">
                                    <em></em>
            ...
            <div class="col-md-4 col-xs-12 col-sm-6">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active">
                        <a href="#home" aria-controls="idx-about" role="tab" data-toggle="tab">公司介绍</a>
                    </li>
                </ul>
                <div class="tab-content">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active">
                        <a href="#idxcontact" aria-controls="idxcontact" role="tab" data-toggle="tab" aria-expanded="false">联系我们</a>
                    </li>
                </ul>
                <div class="tab-content">
